...
1. **主页**：查看今日在线时长和“下一步行动”，点击“开始第一次训练”或“继续上次训练”。
2. **真题训练 / 模拟训练**：选定英语一或英语二，按考试时间完成一篇，不要边写边看范文。
3. **AI 批改**：提交作文，重点看内容、结构、语法、词汇和句式问题，而不是只看总分。
4. **二次重写**：根据批改建议再写一遍，形成“写作 → 反馈 → 重写”的提分闭环。
5. **范文背诵 / 好词好句**：只复习本次作文暴露出的表达问题，避免无目的背诵。
6. **我的弱项**：每周查看一次能力画像，决定下一周只练 1–2 个最弱维度。

建议节奏：工作日完成 1 次 25–30 分钟写作训练，周末做 1 次批改后的二次重写；每天打开主页后只执行一个主任务，完成后再进入素材复习。
