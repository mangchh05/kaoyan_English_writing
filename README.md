...
| 模块 | 说明 |
| --- | --- |
| 主页 | 学习驾驶舱（今日时长、学习日、近 12 周热力矩阵）+ **模拟出题**（图画/图表/书信/通知，随机或指定题型）+ 真题抽题 |
...
**配图能力**：英语一 2010–2024 真题已绑定项目内 `kaoyan_english_cartoon/` 原图；图表作文（英语二全部 + 2025 英语一）继续使用按公开真题数据复刻的 SVG 图表；模拟图画题已预置 `assets/` 图片，也支持配置绘图 API 后一键生成。
